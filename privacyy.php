    ...
    <section class="isii">
        <div class="bg">
            <div class="konten">
                ...
                <p style="margin-bottom: 4rem;">Our website is committed to protecting the privacy of our members. We understand the importance of safeguarding your personal information and ensuring its confidentiality. This Privacy Policy outlines how we collect, use, and protect your data when you use our website or services.</p>

                <h2>INFORMATION COLLECTION AND USE</h2>
                <p style="margin-bottom: 4rem;">We may collect personal information such as your name, email address, phone number, and payment details when you sign up for a membership or use our services. This information is used to provide you with access to our facilities, process payments, communicate with you about your membership, and improve our services.</p>

                <h2>DATA SECURITY</h2>
                <p style="margin-bottom: 4rem;">We take reasonable steps to protect your personal information from unauthorized access, use, or disclosure. We use industry-standard security measures to safeguard your data, including encryption, firewalls, and secure servers.</p>

                <h2>THIRD-PARTY DISCLOSURE</h2>
                <p style="margin-bottom: 4rem;">We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except as required by law or as necessary to provide our services. We may share your information with trusted third parties, such as payment processors or service providers, to facilitate transactions or improve our services.</p>

                <h2>COOKIES AND TRACKING</h2>
                <p style="margin-bottom: 4rem;">We use cookies and similar technologies to enhance your experience on our website. These technologies may collect information about your browsing activities, such as your IP address, browser type, and pages visited. You can manage your cookie preferences through your browser settings.</p>

                <h2>CHILDREN'S PRIVACY</h2>
                <p style="margin-bottom: 4rem;">Our website is not intended for children under the age of 13. We do not knowingly collect personal information from children without parental consent. If you believe that we have inadvertently collected information from a child, please contact us to delete the data.</p>
