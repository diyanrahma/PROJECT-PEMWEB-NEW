...
if(isset($_POST['nama_depan'])){
    ...
    $query_sql = "INSERT INTO hubungi_kami (nama_depan, nama_belakang, no_kontak, email, pesan, tgl_post) 
                  VALUES ('$nama_depan', '$nama_belakang', '$no_kontak', '$email', '$pesan', '$tgl_post')";
    if(mysqli_query($conn, $query_sql)) {
        // Pendaftaran berhasil, arahkan pengguna ke halaman login
        echo "<script>window.location.href = 'contactt.php';</script>";
