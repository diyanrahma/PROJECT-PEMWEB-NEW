...
<body>
    ...
    <section class="hero" id="home">
        <main class="content">
            <h1>FREQUENTLY <br><span>ASKED QUESTIONS</span><h1>
        </main>
    </section>
    ...
    <section class="isii">
        <div class="bg">
            <div class="konten">
                <h2>1. Apa itu membership gym?</h2>
                <p>Membership gym adalah langganan yang memungkinkan Anda mengakses fasilitas dan layanan di pusat kebugaran kami, seperti fasilitas latihan, kelas grup, dan layanan tambahan lainnya.</p><br>

                <h2>2. Apa keuntungan menjadi member gym?</h2>
                <p>Sebagai member gym, Anda mendapatkan akses tak terbatas ke semua fasilitas latihan dan kelas grup yang kami sediakan. Selain itu, Anda juga bisa mendapatkan diskon untuk layanan tambahan seperti personal training.</p><br>

                <h2>3. Bagaimana cara mendaftar sebagai member gym?</h2>
                <p>Anda dapat mendaftar sebagai member gym melalui website kami. Kunjungi halaman pendaftaran dan ikuti langkah-langkah yang tertera di sana untuk mengisi formulir pendaftaran dan pembayaran.</p><br>

                <h2>4. Apa saja jenis keanggotaan yang tersedia?</h2>
                <p>Kami menyediakan beberapa jenis keanggotaan, mulai dari bulanan hingga tahunan. Anda dapat memilih paket yang sesuai dengan kebutuhan dan budget Anda.</p><br>

                <h2>7. Apakah bisa mengganti jenis keanggotaan di tengah masa berlangganan?</h2>
                <p>Ya, Anda bisa mengganti jenis keanggotaan di tengah masa berlangganan. Hubungi tim customer service kami untuk mendapatkan informasi lebih lanjut mengenai prosedur dan biaya yang terkait.</p>
            </div>
        </div>
    </section>
