...
<body>
    ...
    <section class="hero" id="home">
        <main class="content">
            ...
            <a href="layanan.php" class="cta">OUR SERVICE ></a>
        </main>
    </section>

    <section class="galeri">
        <div class="outdoor">
            <a href="galerioutdoort.php" style="text-decoration: none; color: #241c15;"><h2>GALERI OUTDOOR ></h2></a>
        </div>
        <div class="indoor">
            <a href="galeriindoorr.php" style="text-decoration: none; color: #241c15;"><h2>GALERI INDOOR ></h2></a>
        </div>
        <div class="alat">
            <a href="galerialatt.php" style="text-decoration: none; color: #241c15;"><h2>GALERI ALAT ></h2></a>
        </div>
    </section>
    ...
    <section class="layanan">
        <div class="pertama">
            ...
            <a href="layanann.php" class="lengkap">SELENGKAPNYA ></a>
        </div>
        <div class="kedua">
            <div class="grey">
                <h2>GREY ></h2>
